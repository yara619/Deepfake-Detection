...
def index(request):
    if request.method == 'GET':
        ...
        if video_upload_form.is_valid():
            ...
            return redirect('dfd_app:predict')
        else:
            return render(request, index_template_name, {"form": video_upload_form})
    ...
    if request.method == "GET":
        ...
        try:
            ...
            return render(request, predict_template_name,
                          {'preprocessed_images': preprocessed_images, 'heatmap_images': heatmap_images,
                           "faces_cropped_images": faces_cropped_images, "original_video": video_file_name,
                           "models_location": models_location, "output": output, "confidence": confidence})
        except:
