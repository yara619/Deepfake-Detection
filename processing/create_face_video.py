...
video_files = glob.glob('dataset/videos/video15.mp4')
...
def create_face_videos(path_list,out_dir):
  ...
  for path in tqdm(path_list):
    ...
    try:
      ...
      pass
    out.release()
create_face_videos('C:/Users/mehmoodyar.baig/Desktop/deepfake detection/dataset/videos/*.mp4', 'C:/Users/mehmoodyar.baig/Desktop/deepfake detection/dataset/videos/cropped/')